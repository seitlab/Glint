...
embedding_size = 300
dataset_name = 'smt_dataset_dgl.bin'
data_source = '../smt_build_dataset/'

class SMTGraphDataset(DGLDataset):
    def __init__(self):
        super().__init__(name='smt_graph')
...
if __name__ == "__main__":
    SMTGraphDataset=SMTGraphDataset()